...
void forker_command(info_t *);

/* toem_parser.c */
int check_is_command(info_t *, char *);
char *char_dupper(char *, int, int);
...
/* toem_realloc.c */
char *memory_setting(char *, char, unsigned int);
void freefree(char **);
void *_realloc(void *, unsigned int, unsigned int);

/* toem_memory.c */
int free_time_salah(void **);

/* toem_atoi.c */
int inter_shell(info_t *);
...
int putchar_integer(int, int);
char *conv_n(long int, int, int);
void comm_delete(char *);
...
/* toem_builtin1.c */
int histoy_shell(info_t *);
int shell_alias(info_t *);

/*toem_getline.c */
ssize_t input_taker(info_t *);
...
int delete_node_with_index(list_t **, unsigned int);
void free_list(list_t **);

/* toem_lists1.c */
size_t get_list_len(const list_t *);
...
/* toem_vars.c */
int check_is_chain(info_t *, char *, size_t *);
void check_chain_size(info_t *, char *, size_t *, size_t, size_t);
